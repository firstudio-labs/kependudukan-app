...
class AdminPemerintahDesaApiController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        try {
            // Cek apakah ada parameter refresh untuk bypass cache
            ...
            // Jika semua statistik 0, coba tanpa cache
            if ($genderStats['total'] == 0 && $ageGroupStats['total_with_age'] == 0 && $useCache) {
                \Log::warning('Stats are 0, retrying without cache', ['village_id' => $villageId]);
