...
class PemerintahDesaController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $queries = [
            ...
            // 'dataWilayah' => DataWilayah::whereIn('user_id', $userIds)->get(), // dinonaktifkan untuk optimasi performa
        ...
        // $dataWilayah = $queries['dataWilayah'] ?? collect(); // dinonaktifkan
        // $usahaDesa = $queries['usahaDesa'] ?? collect(); // dinonaktifkan
        // $saranaUmum = $queries['saranaUmum'] ?? collect(); // dinonaktifkan
        // $kesenianBudaya = $queries['kesenianBudaya'] ?? collect(); // dinonaktifkan
        // $abdes = $queries['abdes'] ?? collect(); // dinonaktifkan

        // Statistik penduduk desa dan warungku dikomentari untuk mengurangi beban
        ...
        return response()->json([
            ...
            // 'data_wilayah' => $dataWilayah, // dinonaktifkan untuk performa
