        ...
        <ul class="space-y-2 font-medium text-sm">
            ...
            <li>
                {{-- <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-[#2D336B] rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5 text-[#2D336B]" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        viewBox="0 0 22 21">
                        <path
