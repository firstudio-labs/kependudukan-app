        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
            <ul class="space-y-2 font-medium text-sm">
                ...
                @if ($user->role == 'superadmin')
                    ...
                    <li class="-ml-5">
                        ...
                        <ul id="kelolaAsetDropdown" class="hidden space-y-2 pl-6">
                            <li>
                                <a href="{{ route('superadmin.datamaster.klasifikasi.index') }}"
                                    class="flex items-center w-full p-3 pl-6 gap-3 rounded-r-full transition-all duration-300
                            ...
                            <li>
                                <a href="{{ route('superadmin.datamaster.jenis-aset.index') }}"
                                    class="flex items-center w-full p-3 pl-6 gap-3 rounded-r-full transition-all duration-300
                    ...
                    <li class="-ml-5">
                        ...
                        <ul id="masterKeperluanDropdown" class="hidden space-y-2 pl-6">
                            <li>
                                <a href="{{ route('superadmin.datamaster.masterkeperluan.keperluan.index') }}"
                                    class="flex items-center w-full p-3 pl-6 gap-3 rounded-r-full transition-all duration-300
                ...
                @elseif ($user->role == 'user')
                    ...
                    <li class="-ml-5">
                        <a href="{{ route('user.kelola-aset.index') }}"
                            class="flex items-center w-full p-3 pl-6 gap-3 rounded-r-full transition-all duration-300
