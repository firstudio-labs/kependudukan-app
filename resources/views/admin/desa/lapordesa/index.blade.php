    ...
    <div class="p-4 mt-14">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-2">
                <button type="button"
                    onclick="window.location.href='{{ route('admin.desa.datamaster.lapordesa.create') }}'"
                    ...
                    @forelse($lapordesas as $index => $item)
                        <tr class="bg-white border-gray-300 border-b hover:bg-gray-50">
                            ...
                            <td class="flex items-center px-6 py-4 space-x-2">
                                <a href="{{ route('admin.desa.datamaster.lapordesa.edit', $item->id) }}"
                                    class="text-blue-600 hover:text-blue-900">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                                <form action="{{ route('admin.desa.datamaster.lapordesa.destroy', $item->id) }}"
