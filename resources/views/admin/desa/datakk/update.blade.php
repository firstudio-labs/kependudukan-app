    ...
    <div class="p-4 mt-14">
        ...
        <form method="POST" action="{{ route('kk.update', $kk->id) }}" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                <a href="{{ route('admin.desa.datakk.index') }}" class="inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-lg">Batal</a>
