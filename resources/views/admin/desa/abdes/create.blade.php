<x-layout>
    <div class="p-4 mt-14">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Tambah APBDES</h1>
        <p class="text-sm text-gray-500 mb-6">Isi jenis, kategori, dan anggaran.</p>

        <form method="POST" action="{{ route('admin.desa.abdes.store') }}" class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" inputmode="decimal" name="jumlah_anggaran" value="{{ old('jumlah_anggaran') }}" required placeholder="0,00"
