            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        ...
                        <td class="w-1/12">:</td>
                        <td>{{ ucwords(strtolower($kehilangan->full_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>NIK</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tempat Lahir</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($kehilangan->birth_place ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Pekerjaan</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($jobName ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Agama</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            {{ ucwords(strtolower($kehilangan->address ?? '-')) }}
                            RT {{ $kehilangan->rt ?? '0' }},
