<x-layout>
    <div class="p-4 mt-14">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Profil Admin Kabupaten</h1>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="flex flex-col items-center">
                        ...
                        <button type="button" id="change-photo-btn" class="px-4 py-2 bg-[#7886C7] text-white rounded-md hover:bg-[#2D336B] transition">
                            Ubah Logo
                        </button>
                    </div>
                </div>
                ...
                <div class="md:col-span-2">
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {{-- Commented out District/Kabupaten section
                            <div>
                                <label class="block text-gray-600 text-sm font-medium mb-1">Kabupaten/Kota</label>
                                <div class="bg-gray-50 p-2 rounded border border-gray-300 text-gray-800">
                                    {{ $district->name ?? 'Belum diatur' }}
                                </div>
                            </div>
                            --}}

                            {{-- Commented out Province section
                            <div>
                                <label class="block text-gray-600 text-sm font-medium mb-1">Provinsi</label>
                                <div class="bg-gray-50 p-2 rounded border border-gray-300 text-gray-800">
                                    {{ $province->name ?? 'Belum diatur' }}
                                </div>
                            </div>
                            --}}
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 p-2 rounded border border-gray-300 {{ $user->status === 'active' ? 'text-green-600' : 'text-red-600' }} font-medium">
                    ...
                    <div class="flex justify-end">
                        <a href="{{ route('admin.kabupaten.profile.edit') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
                            Edit Profil
                        </a>
                    </div>
                </div>
    ...
    <div id="photo-modal" class="fixed inset-0 flex items-center justify-center z-50 hidden pointer-events-none">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 pointer-events-auto">
            ...
            <form action="{{ route('admin.kabupaten.profile.update-photo') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="mb-4">
                    <div class="flex flex-col items-center">
                        <div class="w-40 h-40 rounded-full bg-gray-200 overflow-hidden mb-4">
                            @if($user->image)
                                <img src="{{ asset('storage/' . $user->image) }}" alt="Preview" class="w-full h-full object-cover" id="preview-image">
                            @else
                                <img src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Preview" class="w-full h-full object-cover" id="preview-image">
                            @endif
                        </div>

                        <label for="image" class="cursor-pointer px-4 py-2 bg-[#7886C7] text-white rounded-md hover:bg-[#2D336B] transition">
                            Pilih Logo
                        </label>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-[#7886C7] text-white rounded-md hover:bg-[#2D336B] transition">
                        Simpan
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        // Instead of creating a full backdrop, we'll just add a subtle backdrop effect to the modal itself
        ...
        function closeModal() {
            ...
            // Disable pointer events for the modal when hidden
