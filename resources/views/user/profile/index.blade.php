                ...
                <div class="relative bg-white rounded-lg shadow-md">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="border rounded-lg p-4">
                                ...
                                <form id="uploadFotoDiriForm" class="mt-2">
                                    ...
                                    <div class="flex items-center">
                                        <input type="file" name="file" id="fotoDiriFile" accept="image/jpeg,image/png"
                                            class="hidden">
                                        <label for="fotoDiriFile"
                                            class="cursor-pointer bg-gray-200 hover:bg-gray-300 text-gray-700 text-sm py-1 px-3 rounded-lg">
                                            Pilih File
                                        </label>
                                        <span id="fotoDiriFileName" class="ml-2 text-sm text-gray-600">Tidak ada file
                                            dipilih</span>
                                    </div>
                                    <button type="submit"
                            ...
                            <div class="border rounded-lg p-4">
                                ...
                                <form id="uploadFotoAktaForm" class="mt-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span id="fotoAktaFileName" class="ml-2 text-sm text-gray-600">Tidak ada file
                                            dipilih</span>
                                    </div>
                                    <button type="submit"
                                        class="w-full mt-2 bg-blue-600 hover:bg-blue-700 text-white text-sm py-1.5 px-4 rounded-lg">
                        ...
                        <div class="border rounded-lg p-4 mt-4">
                            <h4 class="text-md font-semibold mb-2">Tag Lokasi</h4>
                            <p class="text-sm text-gray-600 mb-3">Tag lokasi akan digunakan untuk memverifikasi alamat
                                tempat tinggal.</p>

                            <form id="updateTagLokasiForm">
                                <div class="flex items-center mb-3">
                                    <input type="text" id="tagLokasi" name="tag_lokasi"
                                        class="flex-1 border border-gray-300 rounded-l-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                        placeholder="Masukkan atau gunakan lokasi saat ini">
                                    <button type="button" onclick="getCurrentLocation()"
                                        class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-2 rounded-r-lg">
                    ...
                    <script>
                        ...
                        function resetDocumentForms() {
                            ...
                            document.getElementById('updateTagLokasiForm').reset();
                        ...
                        function getCurrentLocation() {
                            if (navigator.geolocation) {
                                document.getElementById('tagLokasi').value = "Mendapatkan lokasi...";
                                ...
                                navigator.geolocation.getCurrentPosition(
                                    function (position) {
                                        ...
                                        const locationString = `${latitude},${longitude} (akurasi: ${Math.round(accuracy)}m)`;
                                        document.getElementById('tagLokasi').value = locationString;

                                        alert("Lokasi Anda berhasil didapatkan!");
                                    },
                                    function (error) {
                                        ...
                                        document.getElementById('tagLokasi').value = "";
                                        alert(errorMessage);
                                    }, {
                        ...
                        // Tag Lokasi Update
                        function setupTagLokasiUpdate() {
                            const form = document.getElementById('updateTagLokasiForm');

                            form.addEventListener('submit', function (e) {
                                e.preventDefault();

                                const tagLokasi = document.getElementById('tagLokasi').value;
                                if (!tagLokasi) {
                                    alert("Silakan masukkan tag lokasi terlebih dahulu.");
                                    return;
                                }
                                ...
                                fetch(`/user/family-member/${currentNIK}/update-tag-lokasi`, {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                                    ...
                                    .then(data => {
                                        if (data.success) {
                                            alert("Tag lokasi berhasil disimpan!");

                                            const familyMembersTable = document.getElementById('familyMembersTable');
                                            if (familyMembersTable) {
                                                const memberRow = Array.from(familyMembersTable.querySelectorAll('tr')).find(
                                                    row => row.querySelector('td:first-child div')?.textContent?.includes(
                                                        currentNIK)
                                                );

                                                if (memberRow) {
                                                    const locationCell = memberRow.querySelector('td:nth-child(5) div');
                                                    if (locationCell) {
                                                        locationCell.textContent = tagLokasi;
                                                    }
                                                }
                                            }
                                        } else {
                                            alert("Gagal menyimpan tag lokasi: " + (data.message || "Terjadi kesalahan"));
                                        }
                                    ...
                                    .catch(error => {
                                        console.error('Error updating tag lokasi:', error);
                                        alert("Terjadi kesalahan saat menyimpan tag lokasi.");
