        ...
        <x-guest.form-layout
            ...
            @slot('additionalFields')
                ...
                <div class="col-span-full">
                    ...
                    <textarea id="keperluan" name="keperluan" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2"></textarea>
                </div>
