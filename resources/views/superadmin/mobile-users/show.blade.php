<x-layout>
    <div class="p-4 mt-14">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Pengguna Mobile</h1>
                @if(isset($village))
                    <p class="text-sm text-gray-500 mt-1">
                        {{ $province['name'] ?? 'Provinsi' }} > {{ $district['name'] ?? 'Kabupaten' }} > {{ $subDistrict['name'] ?? 'Kecamatan' }} > {{ $village['name'] ?? 'Desa' }}
                    </p>
                @elseif(isset($subDistrict))
                    <p class="text-sm text-gray-500 mt-1">
                        {{ $province['name'] ?? 'Provinsi' }} > {{ $district['name'] ?? 'Kabupaten' }} > {{ $subDistrict['name'] ?? 'Kecamatan' }}
                    </p>
                @elseif(isset($district))
                    <p class="text-sm text-gray-500 mt-1">
                        {{ $province['name'] ?? 'Provinsi' }} > {{ $district['name'] ?? 'Kabupaten' }}
                    </p>
                ...
                @else
                    <p class="text-sm text-gray-500 mt-1">Detail pengguna mobile</p>
                @endif
            </div>
