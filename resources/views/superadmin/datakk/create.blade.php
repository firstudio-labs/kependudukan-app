    ...
    <div class="p-4 mt-14">
        ...
        <form method="POST" action="{{ route('kk.store') }}" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                ...
                <button type="submit"
                    class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#7886C7] text-base font-medium text-white hover:bg-[#2D336B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-lg">Simpan</button>
            </div>
        </form>
    </div>
