<x-layout>
    <div class="p-4 mt-14">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Tambah Klasifikasi Baru</h1>
        </div>

        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('superadmin.datamaster.klasifikasi.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="jenis_klasifikasi" id="jenis_klasifikasi" value="{{ old('jenis_klasifikasi') }}"
                               class="w-full p-2.5 text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                               required>
