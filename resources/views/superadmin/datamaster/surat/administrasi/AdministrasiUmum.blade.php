    ...
    <div class="max-w-4xl mx-auto bg-white p-8">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="flex-1 text-center">
                ...
                <p class="text-sm">
                    Alamat: {{ ucwords(strtolower($village_name ?? 'XXXX')) }}, {{ ucwords(strtolower($subdistrict_name ?? 'XXXX')) }}, {{ ucwords(strtolower($district_name ?? 'XXXX')) }}
                </p>
            </div>
            <div class="w-24">
            </div>
        ...
        <div class="mb-6">
            <p class="mb-4">
                ...
                @endif
                {{ ucwords(strtolower($village_name ?? 'XXXX')) }} Kecamatan {{ ucwords(strtolower($subdistrict_name ?? 'XXXX')) }} dengan ini menerangkan bahwa :
            </p>
        </div>
            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        ...
                        <td class="w-1/12">:</td>
                        <td>{{ ucwords(strtolower($administration->full_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>NIK</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tempat Lahir</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($administration->birth_place ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            {{ ucwords(strtolower($administration->address ?? '-')) }}
