            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        ...
                        <td class="w-1/12">:</td>
                        <td>{{ ucwords(strtolower($domisili->full_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>NIK</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Tempat Lahir</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($domisili->birth_place ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir</td>
                        <td>:</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            {{ ucwords(strtolower($domisili->address ?? '-')) }}
                            RT {{ $domisili->rt ?? '0' }},
        ...
        <div class="mb-6">
            <p class="mb-2">
                ...
                @else
                    XX-XX-XXXX
                @endif
                bahwa benar yang bersangkutan saat ini berdomisili di {{ ucwords(strtolower($domisili->domicile_address ?? '-')) }}.
            </p>
