            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        ...
                        <td class="w-1/12">:</td>
                        <td>{{ ucwords(strtolower($rumahSewa->full_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ ucwords(strtolower($rumahSewa->responsible_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Jalan</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($rumahSewa->street ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Gang/Nomor</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($rumahSewa->alley_number ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>RT</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Kelurahan</td>
                        <td>:</td>
                        <td>{{ ucwords(strtolower($villageName ?? $rumahSewa->village_name ?? 'XXXX')) }}</td>
                    </tr>
                    <tr>
                        <td>Luas Bangunan</td>
                        <td>:</td>
