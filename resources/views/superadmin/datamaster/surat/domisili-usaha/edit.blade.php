<x-layout>
    <div class="p-4 mt-14">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Surat Keterangan Domisili Usaha</h1>

        <form method="POST" action="{{ route('superadmin.surat.domisili-usaha.update', $domisiliUsaha->id) }}" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="nik" name="nik" pattern="\d{16}" maxlength="16" value="{{ $domisiliUsaha->nik }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                </div>

                <!-- Nama Lengkap -->
                <div>
                    <label for="full_name" class="block text-sm font-medium text-gray-700">Nama Lengkap <span class="text-red-500">*</span></label>
                    <input type="text" id="full_name" name="full_name" value="{{ $domisiliUsaha->full_name }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                </div>

                <!-- Tempat Lahir -->
                <div>
                    <label for="birth_place" class="block text-sm font-medium text-gray-700">Tempat Lahir <span class="text-red-500">*</span></label>
                    <input type="text" id="birth_place" name="birth_place" value="{{ $domisiliUsaha->birth_place }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                </div>

                <!-- Tanggal Lahir -->
                <div>
                    <label for="birth_date" class="block text-sm font-medium text-gray-700">Tanggal Lahir <span class="text-red-500">*</span></label>
                    <input type="date" id="birth_date" name="birth_date" value="{{ $domisiliUsaha->birth_date }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                </div>
                ...
                <div>
                    ...
                    <select id="gender" name="gender" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                        ...
                        <option value="1" {{ $domisiliUsaha->gender == '1' ? 'selected' : '' }}>Laki-Laki</option>
                        <option value="2" {{ $domisiliUsaha->gender == '2' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="job_type_id" name="job_type_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                        ...
                        @foreach($jobs as $job)
                            <option value="{{ $job['id'] }}" {{ $domisiliUsaha->job_type_id == $job['id'] ? 'selected' : '' }}>{{ $job['name'] }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="religion" name="religion" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                        ...
                        <option value="1" {{ $domisiliUsaha->religion == '1' ? 'selected' : '' }}>Islam</option>
                        <option value="2" {{ $domisiliUsaha->religion == '2' ? 'selected' : '' }}>Kristen</option>
                        <option value="3" {{ $domisiliUsaha->religion == '3' ? 'selected' : '' }}>Katholik</option>
                        <option value="4" {{ $domisiliUsaha->religion == '4' ? 'selected' : '' }}>Hindu</option>
                        <option value="5" {{ $domisiliUsaha->religion == '5' ? 'selected' : '' }}>Buddha</option>
                        <option value="6" {{ $domisiliUsaha->religion == '6' ? 'selected' : '' }}>Kong Hu Cu</option>
                        <option value="7" {{ $domisiliUsaha->religion == '7' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <textarea id="address" name="address" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>{{ $domisiliUsaha->address }}</textarea>
                </div>

                <!-- RT -->
                <div>
                    <label for="rt" class="block text-sm font-medium text-gray-700">RT <span class="text-red-500">*</span></label>
                    <input type="text" id="rt" name="rt" value="{{ $domisiliUsaha->rt }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="letter_number" name="letter_number" value="{{ $domisiliUsaha->letter_number }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="signing" name="signing" value="{{ $domisiliUsaha->signing }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2">
                </div>
                ...
                <div>
                    ...
                    <select id="province_code" name="province_code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg p-2" required>
                        ...
                        @foreach($provinces as $province)
                            <option value="{{ $province['code'] }}" data-id="{{ $province['id'] }}" {{ $domisiliUsaha->province_id == $province['id'] ? 'selected' : '' }}>{{ $province['name'] }}</option>
                        @endforeach
                    </select>
                    <input type="hidden" id="province_id" name="province_id" value="{{ $domisiliUsaha->province_id }}">
                </div>
                ...
                <div>
                    ...
                    <input type="hidden" id="district_id" name="district_id" value="{{ $domisiliUsaha->district_id }}">
                </div>
                ...
                <div>
                    ...
                    <input type="hidden" id="subdistrict_id" name="subdistrict_id" value="{{ $domisiliUsaha->subdistrict_id }}">
                </div>
                ...
                <div>
                    ...
                    <input type="hidden" id="village_id" name="village_id" value="{{ $domisiliUsaha->village_id }}">
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const originalProvinceId = "{{ $domisiliUsaha->province_id }}";
            const originalDistrictId = "{{ $domisiliUsaha->district_id }}";
            const originalSubdistrictId = "{{ $domisiliUsaha->subdistrict_id }}";
            const originalVillageId = "{{ $domisiliUsaha->village_id }}";
