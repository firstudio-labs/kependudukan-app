<x-layout>
    <div class="p-4 mt-14">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Buat Surat SKCK</h1>

        <form method="POST" action="{{ route('superadmin.surat.skck.store') }}" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeSelect2WithData() {
                ...
                $('#nikSelect').on('select2:select', function (e) {
                    ...
                    if (citizen) {
                        ...
                        // Ensure job_type_id is set correctly (assuming job_type_id from citizen)
                ...
                $('#fullNameSelect').on('select2:select', function (e) {
                    ...
                    if (citizen) {
                        ...
                        // Fill in personal details fields using the same logic as above
                        $('#birth_place').val(citizen.birth_place || '');
                        ...
                        // NOTE: We deliberately DO NOT populate location fields
                    }
            ...
            // Keep the existing code for province/district/subdistrict/village cascading selects
